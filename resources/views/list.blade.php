...
@section('content')
    <div class="bg-indigo-900 py-4 lg:px-4">
        <div class="p-2 bg-indigo-800 items-center text-indigo-100 leading-none lg:rounded-full flex lg:inline-flex" role="alert">
                ...
                <svg class="fill-current opacity-75 h-4 w-4" transform="scale(-1,1)" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"><path d="M12.95 10.707l.707-.707L8 4.343 6.586 5.757 10.828 10l-4.242 4.243L8 15.657l4.95-4.95z"/></svg>
    ...
    <div class="flex flex-col w-full h-screen items-center pt-4 bg-grey-lighter">
        ...
        <div class="w-1/2 py-2 rounded overflow-hidden shadow-lg">
            <div class="px-6 py-4">
                <div class="text-gray-700 text-base inline-flex items-center"><img class="w-4 mr-4" src="img/document.svg" alt=""> <a href="/storage/{{ $file->url  }}">{{ $file->url }}</a></div>
            </div>
            <div class="px-6 py-4">
